...
//        System.out.println(n2);
        factor n3 = ve.join(n, ve.factors.get(4), BN.returnByName("A"));
        System.out.println(n3);
        factor elim1 = ve.eliminate(n3, BN.returnByName("A"));
        System.out.println(elim1);
        factor n4 = ve.join(ve.factors.get(1), elim1, BN.returnByName("E"));
        System.out.println(n4);
        factor elim2 = ve.eliminate(n4, BN.returnByName("E"));
        System.out.println(elim2);
        factor n5 = ve.join(ve.factors.get(0), elim2, BN.returnByName("B"));
